...
# Note that we must put /opt/homebrew/opt/bc/bin in front of PATH
# for brew version bc to be run first
# Because shell searches the PATH variable from left to right and terminates once it finds.
export PATH="/opt/homebrew/opt/bc/bin:$PATH"
export PATH="$HOME/.cargo/bin:$PATH"

# use gnu gawk coreutils
